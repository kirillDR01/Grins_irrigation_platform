...
- [ ] 1. Database migrations, models, and schemas
  ...
  - [ ] 1.2 Create SQLAlchemy models for new tables
  ...
  - [ ] 1.3 Extend existing models with new columns
...
- [ ] 2. Checkpoint — Database and schema foundation
...
- [ ] 3. Core services — CriteriaEvaluator and 6 scorer modules
  ...
  - [ ] 3.3 Implement ResourceScorer (criteria 6–10)
  ...
  - [ ] 3.4 Implement CustomerJobScorer (criteria 11–15)
  ...
  - [ ] 3.5 Implement CapacityDemandScorer (criteria 16–20)
  ...
  - [ ] 3.6 Implement BusinessRulesScorer (criteria 21–25)
  ...
  - [ ] 3.7 Implement PredictiveScorer (criteria 26–30)
...
- [ ] 4. Checkpoint — Core scoring engine
...
- [ ] 5. AI services — SchedulingChatService, AlertEngine, PreJobGenerator, ChangeRequestService
  ...
  - [ ] 5.2 Implement admin scheduling tool functions
  ...
  - [ ] 5.3 Implement resource scheduling tool functions
  ...
  - [ ] 5.4 Implement AlertEngine service
  ...
  - [ ] 5.5 Implement PreJobGenerator service
  ...
  - [ ] 5.6 Implement ChangeRequestService
  ...
  - [ ] 5.7 Implement resource alert generation for mobile view
  ...
  - [ ] 5.8 Implement external service integrations and fallbacks
  ...
  - [ ] 5.9 Implement data migration and onboarding utilities
  ...
  - [ ] 5.10 Implement security, guardrails, and audit trail
  ...
  - [ ] 5.11 Implement LLM configuration and AI cost tracking
  ...
  - [ ] 5.12 Implement storage limits and scalability
...
- [ ] 6. Checkpoint — AI services complete
...
- [ ] 7. API routes — AI scheduling, alerts, and schedule extensions
  - [ ] 7.1 Create AI scheduling API router
  ...
  - [ ] 7.3 Extend existing schedule API router
  ...
  - [ ] 7.4 Register new routers in main API router
  ...
  - [ ] 7.5 Update `.env.example` with new environment variables
...
- [ ] 10. Frontend — Alerts/Suggestions Panel
  ...
  - [ ] 10.4 Create RouteSwapMap component
  ...
  - [ ] 10.5 Create ChangeRequestCard component
  ...
  - [ ] 10.6 Create TanStack Query hooks for alerts
  ...
  - [ ] 10.7 Create alert types and API client
...
- [ ] 11. Frontend — AI Chat extensions
  ...
  - [ ] 11.3 Create PreJobChecklist component
  ...
  - [ ] 11.4 Create TanStack Query hooks for AI chat
...
- [ ] 12. Frontend — Resource Mobile View
  ...
  - [ ] 12.2 Create ResourceAlertsList component
  ...
  - [ ] 12.3 Create ResourceSuggestionsList component
  ...
  - [ ] 12.4 Create resource mobile types, API client, and hooks
...
- [ ] 14. Unit tests with Property-Based Testing (PBT) — Hypothesis strategies and properties 1–11
  - [ ] 14.1 Create Hypothesis strategies and test infrastructure
  ...
  - [ ] 14.2 Write PBT for Property 1: Hard Constraint Invariant
  ...
  - [ ] 14.3 Write PBT for Property 2: Alert Detection Accuracy
  ...
  - [ ] 14.4 Write PBT for Property 3: Proximity Scoring Monotonicity
  ...
  - [ ] 14.5 Write PBT for Property 4: Intra-Route Drive Time Minimization
  ...
  - [ ] 14.6 Write PBT for Property 5: Zone Boundary Preference
  ...
  - [ ] 14.7 Write PBT for Property 6: Workload Balance
  ...
  - [ ] 14.8 Write PBT for Property 7: Priority and CLV Ordering
  ...
  - [ ] 14.9 Write PBT for Property 8: Capacity Utilization Calculation
  ...
  - [ ] 14.10 Write PBT for Property 9: Backlog Pressure Monotonicity
  ...
  - [ ] 14.11 Write PBT for Property 10: Revenue Per Resource-Hour Calculation
  ...
  - [ ] 14.12 Write PBT for Property 11: Overtime Cost-Benefit
...
- [ ] 15. Unit tests with PBT — Properties 12–22 and criteria unit tests
  - [ ] 15.1 Write PBT for Property 12: Weather Impact on Outdoor Jobs
  ...
  - [ ] 15.2 Write PBT for Property 13: Dependency Chain Ordering
  ...
  - [ ] 15.3 Write PBT for Property 14: Route Swap Improvement Guarantee
  ...
  - [ ] 15.4 Write PBT for Property 15: Pre-Job Checklist Completeness
  ...
  - [ ] 15.5 Write PBT for Property 16: Nearby Work Radius and Skill Filtering
  ...
  - [ ] 15.6 Write PBT for Property 17: Parts Low-Stock Threshold Alert
  ...
  - [ ] 15.7 Write PBT for Property 18: 30-Criteria Evaluation Completeness
  ...
  - [ ] 15.8 Write PBT for Property 19: PII Protection in AI Outputs
  ...
  - [ ] 15.9 Write PBT for Property 20: Audit Trail Completeness
  ...
  - [ ] 15.10 Write PBT for Property 21: Resource Chat Routing Completeness
  ...
  - [ ] 15.11 Write PBT for Property 22: Constraint Parsing Round-Trip
  ...
  - [ ] 15.12 Write unit tests for all 30 criteria scorers individually
  ...
  - [ ] 15.13 Write unit tests for alert and suggestion generation logic
  ...
  - [ ] 15.14 Write unit tests for ChangeRequest packaging logic
  ...
  - [ ] 15.15 Write unit tests for PreJobGenerator, revenue/hour, capacity utilization, backlog pressure
...
- [ ] 16. Checkpoint — Unit tests and PBT complete
...
- [ ] 17. Functional testing — User Admin and Resource workflows
  - [ ] 17.1 Create functional test infrastructure
  ...
  - [ ] 17.2 Write functional tests for User Admin workflows
  ...
  - [ ] 17.3 Write functional tests for Resource workflows
  ...
  - [ ] 17.4 Write functional tests for constraint satisfaction and alert pipeline
  ...
  - [ ] 17.5 Verify all functional tests pass
...
- [ ] 18. Integration testing — Cross-component and external service validation
  - [ ] 18.1 Create integration test infrastructure
  ...
  - [ ] 18.2 Write integration tests for external service integrations
  ...
  - [ ] 18.3 Write integration tests for cross-component data flows
  ...
  - [ ] 18.4 Write integration tests for API endpoints
  ...
  - [ ] 18.5 Write integration tests for auth, rate limiting, and role-based access
  ...
  - [ ] 18.6 Verify all integration tests pass
...
- [ ] 19. Checkpoint — Backend testing complete
...
- [ ] 20. Frontend component tests
  - [ ] 20.1 Write tests for Schedule Overview extension components
  ...
  - [ ] 20.2 Write tests for Alerts/Suggestions Panel components
  ...
  - [ ] 20.3 Write tests for AI Chat extension components
  ...
  - [ ] 20.4 Write tests for Resource Mobile View components
  ...
  - [ ] 20.5 Verify all frontend tests pass with coverage
...
- [ ] 21. End-to-End browser testing with agent-browser
  - [ ] 21.1 Create E2E test script for Schedule Overview
  ...
  - [ ] 21.2 Create E2E test script for Alerts/Suggestions Panel
  ...
  - [ ] 21.3 Create E2E test script for AI Chat (Admin)
  ...
  - [ ] 21.4 Create E2E test script for Resource Mobile Chat
  ...
  - [ ] 21.5 Create E2E test script for responsive behavior
  ...
  - [ ] 21.6 Register E2E tests in test runner and add pre-flight checks
...
- [ ] 22. Checkpoint — All testing complete
...
- [ ] 23. Code quality, linting, type safety, and simulation testing
  - [ ] 23.1 Run and fix Ruff linting on all scheduling code
  ...
  - [ ] 23.2 Run and fix MyPy type checking on all scheduling code
  ...
  - [ ] 23.3 Run and fix Pyright type checking on all scheduling code
  ...
  - [ ] 23.4 Implement simulation testing infrastructure
  ...
  - [ ] 23.5 Verify interacting business component data sourcing
