...
// Drop at: frontend/src/features/sales/lib/nowContent.ts
// ============================================================
...
function act(
  kind: Exclude<NowAction['kind'], 'locked'>,
  label: string,
  testId: string,
  onClickId: NowAction extends { onClickId: infer I } ? I : never,
  icon?: NowAction extends { icon?: infer I } ? I : never,
): NowAction {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  return { kind, label, testId, onClickId, icon } as any;
}
