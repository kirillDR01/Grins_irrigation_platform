...
| M-9 — Auto-reply + follow-up bypass SentMessage | 2026-04-16 | `9ba1d6d` | `fix/medium-bughunt-batch` | Both routes now go through `SMSService.send_message` with new `APPOINTMENT_CONFIRMATION_REPLY` + `RESCHEDULE_FOLLOWUP` MessageType values. Migration `20260416_100000` widens the CHECK constraint. |
